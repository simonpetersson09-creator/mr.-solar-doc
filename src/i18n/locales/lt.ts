export const lt = {
  ...
  "result": {
    ...
    "paybackSubtitle": "Pažiūrėkite, koks investicijos lygis atitinka skirtingus atsipirkimo terminus.",
    ...
    "investmentLevelNote": "Remiantis šiandienos skaičiavimo prielaidomis, {{years}} metų atsipirkimas atitinka maždaug {{amount}} investiciją.",
    ...
    "paybackScenariosHelp": "Trumpesnis atsipirkimo laikas reiškia mažesnę galimą investiciją. Čia matote, kaip keičiasi investicijos lygis, jei sutinkate su trumpesniu ar ilgesniu atsipirkimo laiku.",
    "paybackInfo": "Atsipirkimo laikas rodo, kiek metų numatoma metinė ekonominė vertė atitinka investiciją. Atsipirkimas neatsižvelgia į tokius veiksnius kaip būsimi elektros kainų pokyčiai, finansavimo išlaidos, infliacija, priežiūra ar diskontavimas.",
    ...
    "productionCostInfo": "Skaičius pagrįstas didžiausia investicija, atitinkančia pasirinktą atsipirkimo laiką, padalyta iš visos elektros, kurią sistema turėtų pagaminti per skaičiavimo laikotarpį. Tai nėra rinkos kaina už įrengimą.",
    "maxInvestmentExplainer": "Norint pasiekti maždaug {{years}} metų atsipirkimą, įrengimas turėtų kainuoti ne daugiau kaip apie {{amount}}.",
    ...
    "selfConsumptionEstimatedHelp": "Įvertinta pagal jūsų elektros suvartojimą ir apskaičiuotą sistemos gamybą. Reikšmę galite pakeisti rankiniu būdu.",
  ...
  "report": {
    "fields": {
      ...
      "lifetimeNote": "Skaičiavimas rodo numatomą raidą per {{years}} metus, remiantis apskaičiuota gamyba, prielaida dėl degradacijos ir pasirinkta elektros kainų raida. Faktinis ekonominis rezultatas ir gamyba laikui bėgant gali skirtis.",
      "yearShort": "Metai",
      ...
      "summaryMethodFlat": "Apskaičiuota taikant {{degradation}} % metinį gamybos mažėjimą ir nekintančias savo reikmėms suvartotos bei parduotos saulės elektros vertes.",
      "summaryMethodTrend": "Apskaičiuota taikant {{degradation}} % metinį gamybos mažėjimą ir prielaidą, kad saulės elektros vertė kasmet kinta {{priceChange}} %.",
      "specificYieldNote": "Gamybos potencialas yra apskaičiuota šios vietos gamyba vienam įrengtam kWp pagal jūsų stogo kryptį ir nuolydį. Tai nėra bendra metinė sistemos gamyba.",
      "investmentNote": "Investicijų lygis rodo, kokia maždaug investicija atitinka pasirinktą atsipirkimo laiką pagal sukauptą skaičiavimo ekonominę vertę iki tų metų. Tai nėra rinkos kainos įvertinimas ar pasiūlymas.",
      ...
      "lifetimeInvestmentLink": "Sukaupta ekonominė vertė iki {{years}} metų yra maždaug {{amount}} investicijų lygio pagrindas - tai tas pats skaičiavimas, tik suapvalintas.",
