export const fi = {
  ...
  "result": {
    ...
    "paybackScenariosHelp": "Lyhyempi takaisinmaksuaika tarkoittaa pienempää mahdollista investointia. Tässä näet, miten investointitaso muuttuu, jos hyväksyt lyhyemmän tai pidemmän takaisinmaksuajan.",
    ...
    "productionCostInfo": "Luku perustuu suurimpaan investointiin, joka sopii valitsemaasi takaisinmaksuaikaan, jaettuna koko laskentajakson arvioidulle tuotannolle. Se ei ole asennuksen markkinahinta.",
    ...
    "selfConsumptionEstimatedHelp": "Arvioitu sähkönkulutuksesi ja järjestelmän lasketun tuotannon perusteella. Voit säätää arvoa itse.",
  ...
  "report": {
    "fields": {
      ...
      "lifetimeNote": "Laskelma näyttää arvioidun kehityksen {{years}} vuoden aikana lasketun tuotannon, oletetun heikkenemisen ja valitun sähkön hintakehityksen perusteella. Todellinen taloudellinen tulos ja tuotanto voivat poiketa ajan myötä.",
      "yearShort": "Vuosi",
