export const fi = {
  ...
  consumption: {
    validation: {
      ...
      monthOutOfRange: "Yksi kuukausi on huomattavasti muita korkeampi. Tarkista kuukausiarvosi ennen jatkamista.",
      monthUneven: "Yksi kuukausi erottuu muista. Tarkista se, jos se ei pidä paikkaansa.",
    },
    shape: {
...
evenHelp: "Saman verran kulutusta ympäri vuorokauden.",
  ...
  meta: {
    ...
    paywall: {
      title: "Avaa laskelmasi - Mr. Solar Doc",
      description:
        "Avaa aurinkosähkölaskelmasi kertaostoksella tai hanki Premium rajattomiin laskelmiin.",
      ogDescription: "Avaa koko aurinkosähkölaskelma ja PDF-raportti.",
    },
  },
  months: {
  ...
  report: {
    ...
    generated: "Luotu",
    installerChecklistTitle: "Käytävä läpi asentajan kanssa",
    installerChecklistItems: [
      "Vahvista katon suunta, kaltevuus ja mahdollinen varjostus paikan päällä.",
      "Huomaa, että järjestelmän kokoa voidaan joutua säätämään katon todellisten olosuhteiden, kuten savupiippujen, tuuletusaukkojen tai rajallisen käytettävissä olevan pinta-alan mukaan.",
      "Tarkista pääsulake ja liittymäehdot verkkoyhtiöltäsi.",
      "Varmista, että invertterin teho {{acPower}} sopii sähköliittymääsi.",
      "Vertaa asentajan arvioimaa vuosituotantoa tämän raportin arvoon {{production}}. Arviot voivat vaihdella olosuhteiden ja laskentatavan mukaan.",
      "Kysy, onko invertteri valmis tulevaa akkuvarastointia varten, jos se voi olla tarpeen myöhemmin.",
      "Varmista, että sähkökeskus ja nykyinen sähköasennus sopivat asennukseen.",
      "Käy läpi, mitä tarjous sisältää, esimerkiksi kaapeloinnin, asennustelineet, suojauksen ja muut asennusmateriaalit.",
      "Kysy, kuka vastaa mahdollisista katolle asennuksen aikana aiheutuvista vahingoista.",
      "Käy läpi tuotannon seuranta, takuut ja huolto.",
      "Pyydä tarjous tämän raportin mitoituksen perusteella: {{kwp}} · {{production}}.",
      "Vertaa tarjottua hintaa tämän raportin laskettuun tasoon {{investment}}. Hinta voi vaihdella laitteiston, asennusolosuhteiden ja toimitussisällön mukaan.",
    ],
