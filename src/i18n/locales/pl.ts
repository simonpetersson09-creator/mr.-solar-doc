export const pl = {
  ...
  "result": {
    ...
    "paybackScenariosHelp": "Krótszy okres zwrotu oznacza niższą możliwą inwestycję. Tutaj zobaczysz, jak zmienia się poziom inwestycji, jeśli zaakceptujesz krótszy lub dłuższy okres zwrotu.",
    ...
    "productionCostInfo": "Kwota opiera się na maksymalnej inwestycji zgodnej z wybranym okresem zwrotu, rozłożonej na całą energię, jaką instalacja ma wyprodukować w okresie obliczeniowym. To nie jest cena rynkowa instalacji.",
    ...
    "selfConsumptionEstimatedHelp": "Oszacowana na podstawie Twojego zużycia energii i obliczonej produkcji instalacji. Możesz ręcznie zmienić wartość.",
