export const cs = {
  ...
  address: {
    ...
    marketUnsupported:
      "Mr. Solar Doc tuto zemi zatím nepodporuje. Pokračujte výběrem adresy v podporované zemi.",
  ...
  roof: {
    ...
    unit: "kWh/kWp/rok",
    error:
      "V tuto chvíli se nepodařilo načíst data o solární výrobě pro dané místo. Hodnoty nejsou odhadovány.",
    errorOverSea:
  ...
  consumption: {
    ...
    shape: {
      ...
      defaultNote:
        "Používáme normální odhadované rozdělení vaší roční spotřeby. Můžete to změnit později.",
      even: {
    ...
    upload: {
      ...
      sectionHint:
        "Přiložte fakturu za elektřinu nebo údaje o spotřebě za 12 měsíců a my za vás vyplníme hodnoty.",
  ...
  fuse: {
    ...
    title: "Jaký máte hlavní jistič?",
    subtitle:
      "Hlavní jistič slouží k odhadu, jak velký střídač lze běžně připojit. Skutečný povolený výkon určuje provozovatel sítě.",
    label: "Hlavní jistič",
    other: "Jiný",
    otherLabel: "Ampéry",
    ...
    noCountryOptions:
      "Pro tuto zemi zatím nemáme ověřené možnosti připojení. Zadejte hlavní jistič v ampérech a v případě potřeby upravte nastavení sítě níže.",
    unverifiedCountryNotice:
      "Síťový standard této země jsme neověřili. Zkontrolujte napětí, počet fází a velikost jističe na faktuře za elektřinu nebo u svého distributora a potvrďte níže.",
...
even: "Rovnoměrné",
evenHelp: "Přibližně stejná spotřeba po celý den.",
    },
    ...
    estimatedConsumptionNote:
      "Měsíční spotřeba je odhadnuta z vaší roční hodnoty a zvoleného profilu.",
    ...
    coverageNote:
      "Toto srovnává celkovou roční výrobu s celkovou roční spotřebou. Nejedná se o ukazatel soběstačnosti.",
    ...
    priceScenarioHint:
      "Předpoklad roční změny, nikoli prognóza. Cena se v průběhu výpočetního období navyšuje rok od roku.",
    ...
    standardValueHint:
      "Standardní hodnoty pro výpočet. Změňte je na hodnoty z vlastní smlouvy o dodávce elektřiny pro individuálnější výsledek.",
    exportValueInfo:
      "Zadejte celkovou kompenzaci za kWh za elektřinu, kterou odevzdáváte do sítě, včetně případné výhody ze sítě nebo jiné kompenzace související s vývozem.",
    editable: "Upravitelné",
    editableTooltip: "Změnit předpoklad",
    fuseLimit: "Teoretický výkonový limit z hlavního jističe",
    fuseLimitInfo:
      "Vypočítáno z hlavního jističe a napětí sítě. Skutečně povolený výkon střídače nebo dodávky může být omezen provozovatelem distribuční soustavy a místními síťovými pravidly.",
    reason: {
      profileUnknown:
        "Dimenzování je přizpůsobeno vaší spotřebě elektřiny a odhadované výrobě solární energie.",
      profileNormal:
        "Dimenzování je přizpůsobeno vaší spotřebě elektřiny a odhadované výrobě solární energie.",
      profileLowSolarSeason:
        "Velká část vaší spotřeby elektřiny probíhá, když je solární výroba nižší, takže systém nebyl dále naddimenzován.",
      profileHighSolarSeason:
        "Využíváte relativně hodně elektřiny během slunečných měsíců, takže může být vhodný o něco vyšší výkon panelů vzhledem ke střídači.",
      profileVeryHighSolarSeason:
        "Vaše spotřeba elektřiny je jasně soustředěna do slunečných měsíců, proto je navržen vyšší výkon panelů vzhledem ke střídači.",
      gridLimit:
        "Systém je omezen vaším hlavním jističem – vaše síťové připojení neumožňuje vyšší výkon.",
    ...
    monthlyDataNote:
      "Měsíční hodnoty neukazují, zda se elektřina spotřebovává ve dne nebo v noci. Používají se proto jako vodítko pro dimenzování, nikoli jako důkaz toho, kolik solární energie můžete sami využít.",
    ...
    bindingLimitLabel: "Omezeno",
    bindingConnectionCapacity: "Kapacita přípojky",
    bindingPvRule: "Národní pravidlo pro FV",
    bindingCapacityShare: "Podíl kapacity přípojky",
    bindingBusbar: "Pravidlo přípojnice / zpětného napájení",
    reasonPvRuleLimit: "Velikost systému určuje národní pravidlo pro připojení FV, nikoli hlavní jistič.",
    reasonBusbarLimit: "Velikost systému určuje pravidlo zpětného napájení vašeho rozváděče, nikoli hlavní jistič.",
    simplifiedProcessNote: "Systémy nad {{limit}} kW nespadají do zjednodušeného procesu připojení. Systém je stále možný, obvykle však vyžaduje žádost a souhlas provozovatele distribuční soustavy.",
    summerShare: "Podíl spotřeby dub–září",
    rationale: {
      consumption:
        "Dimenzováno tak, aby produkovalo přibližně stejné množství elektřiny jako vaše roční spotřeba elektřiny.",
      gridLimit:
        "Systém je omezen vaším hlavním jističem – vaše síťové připojení neumožňuje vyšší výkon.",
    ...
    selfConsumedValueHelp:
      "Spotřebovaná vlastní solární energie nahrazuje elektřinu, kterou byste jinak museli koupit ze sítě.",
    ...
    investmentLevelNote:
      "S dnešními předpoklady výpočtu odpovídá {{years}} let doby návratnosti investici přibližně {{amount}}.",
    ...
    quoteNote:
      "Výpočet používá stejnou výrobu, vlastní spotřebu a ceny elektřiny jako váš aktuální výpočet.",
    priceExplainer:
      "Spotřebovaná vlastní solární energie nahrazuje elektřinu, která by jinak musela být zakoupena ze sítě. Prodaná solární energie naopak přináší náhradu za elektřinu dodanou do sítě.",
    ...
    investmentLevelInfo:
      "Přibližně ukazuje, jaká investiční částka odpovídá vámi zvolené době návratnosti. Nejde o odhad skutečných nákladů na instalaci. Skutečná cena závisí mimo jiné na střeše, instalaci, komponentech a dodavateli.",
    systemSizeInfoLabel: "Více informací",
    systemSizeInfo:
      "Výpočet je odhadem a měl by sloužit jako orientace. Skutečná výroba, vlastní spotřeba, cena elektřiny, kompenzace, náklady na instalaci a ekonomický výsledek se mohou lišit. Výsledek nepředstavuje nabídku ani záruku.",
    productionCostInfoLabel: "Více informací",
    productionCostInfo:
      "Číslo vychází z maximální investice odpovídající zvolené době návratnosti, rozpočítané na veškerou elektřinu, kterou má systém vyrobit za dobu výpočtu. Nejde o tržní cenu instalace.",
    maxInvestmentExplainer:
      "Pro dosažení přibližně {{years}} let doby návratnosti by instalace měla stát maximálně kolem {{amount}}.",
    maxInvestmentNote:
      "Částka je vypočítána z vašich vstupů a předpokladů výpočtu – nejedná se o nabídku ani odhad tržní ceny.",
    missingMarketValues:
      "Pro tuto zemi nemáme ověřenou standardní hodnotu. Zadejte hodnoty sami níže.",
    currency: "Měna",
    economicValue: "Základní ekonomická hodnota",
    perYear: "za rok",
    adjustAssumptions: "Upravit předpoklady",
    adjustAssumptionsHint:
      "Změňte vlastní spotřebu, ceny elektřiny a požadovanou dobu návratnosti.",
    ...
    consumptionTooLowNote:
      "Zadaná spotřeba elektřiny je velmi nízká, výsledek proto berte pouze jako orientační.",
    ...
    productionCostExplainer:
      "Náklady na systém dělíme odhadovanou produkcí za celé výpočetní období.",
    ...
    productionCostHigherValue:
      "V tomto výpočtu má každá kWh vyšší hodnotu, než kolik stojí její výroba.",
    ...
    gridTooSmallBody:
      "Vaše současná přípojka ({{maxKw}} kW) je příliš malá pro nejmenší podporovanou velikost systému (střídač {{minKw}} kW). Pro pokračování zvyšte hlavní jistič nebo sjednaný příkon.",
    missingSelfConsumedValue:
      "Chybí cena elektřiny. Zadejte, kolik platíte za kWh, abyste viděli hodnotu vlastní spotřeby solární energie.",
    missingExportValue:
      "Chybí výkupní cena. Zadejte, kolik dostanete za dodanou kWh, abychom spočítali výnos z prodeje.",
    missingInstallationCost:
      "Chybí cena instalace. Zadejte svou nabídku nebo odhadovanou investici.",
    economicsIncomplete: "Neúplný podklad",
    enterValues: "Zadat hodnoty",
    economicsRequiresPrice:
      "Ekonomický výpočet vyžaduje cenu elektřiny. Zadejte své ceny, abyste viděli úsporu, návratnost a výrobní cenu.",
    economicsRequiresPriceShort: "Vyžaduje cenu elektřiny",
    gridUnverifiedTitle: "Síťové údaje nejsou ověřeny",
    gridUnverifiedWarning:
      "Předpoklady o síti vycházejí z obecných hodnot a před instalací je nutné je ověřit lokálně.",
    ...
    calcErrorBody:
      "S některými údaji nelze počítat. Vraťte se zpět a zkontrolujte spotřebu, připojení k síti a předpoklady.",
  },
  units: {
    kwhPerYear: "kWh/rok",
    kwhPerKwp: "kWh/kWp",
  ...
  meta: {
    home: {
      ...
      description:
        "Vypočítejte doporučený solární výkon, velikost střídače a roční výrobu na základě vaší adresy, spotřeby elektřiny a hlavního jističe.",
      ogDescription:
        "Krok za krokem výpočet s daty o poloze z PVGIS: kWp, střídač, měsíční výroba a ekonomika.",
    },
    result: {
  ...
  report: {
    ...
    fields: {
      ...
      gridConnectionValue: "{{voltage}} V, {{phases}} fáze",
      gridMethodNote:
        "Teoretický AC výkon vychází z třífázové přípojky 400 V a počítá se jako 1,73 × 400 V × hlavní jistič. Skutečný povolený připojovací nebo dodávaný výkon může být omezen provozovatelem sítě nebo konkrétní instalací.",
      gridMethodNoteContracted:
        "Skutečný povolený připojovací nebo dodávaný výkon může být omezen provozovatelem sítě nebo konkrétní instalací.",
      savings30Short:
        "Vypočítáno s {{degradation}} % roční degradací výroby a nezměněnými hodnotami elektřiny.",
      ...
      selfConsumptionRateNote:
        "Míra vlastní spotřeby ukazuje, kolik vyrobené solární elektřiny je přímo spotřebováno v nemovitosti.",
      selfSufficiencyRateNote:
        "Míra soběstačnosti ukazuje, jak velká část celkové spotřeby elektřiny v nemovitosti je přímo pokryta solární energií.",
      ...
      priceMethodNote:
        "Hodnoty elektřiny jsou předpoklady výpočtu. Skutečná hodnota vlastní spotřeby a prodané solární elektřiny závisí na smlouvě, poplatcích, daních, pravidlech a tržních podmínkách.",
      ...
      priceChangeNote:
        "Změna ceny elektřiny o {{priceChange}} % ročně znamená, že výpočet počítá s nezměněnými hodnotami vlastní spotřeby a prodané solární elektřiny po celé období. Nepřidáváme tedy žádné předpokládané zvýšení cen, protože budoucí ceny elektřiny nelze předpovědět. Vyšší budoucí ceny znamenají vyšší hodnotu, než je uvedeno, nižší ceny znamenají nižší hodnotu.",
      calculationPeriodNote:
        "Období výpočtu {{years}} let je časové rozpětí, které pokrývá, a odpovídá normální technické životnosti solárního systému. Všechny dlouhodobé částky ve zprávě jsou součtem od roku 1 do roku {{years}}, přičemž výroba klesá o {{degradation}} % ročně.",
      ...
      lifetimeNote:
        "Výpočet ukazuje odhadovaný vývoj za {{years}} let na základě vypočtené výroby, předpokládané degradace a zvoleného vývoje ceny elektřiny. Skutečný ekonomický výsledek a výroba se mohou v čase lišit.",
      yearShort: "Rok",
      reportId: "ID zprávy",
      uncertaintyTitle: "Co může ovlivnit výsledek?",
      uncertaintyText:
        "Skutečná solární výroba a ekonomický výsledek se mohou lišit od výpočtu. Výsledek je ovlivněn mimo jiné kolísáním počasí, zastíněním, orientací a sklonem panelů, skutečnou spotřebou elektřiny a jejím časem, cenami elektřiny, kompenzací za export a výkonem systému v čase.",
      panelPower: "Výkon panelů",
      summaryMethodFlat:
        "Vypočteno s roční degradací výroby {{degradation}} % a neměnnými hodnotami vlastní spotřeby a prodané solární elektřiny.",
      summaryMethodTrend:
        "Vypočteno s roční degradací výroby {{degradation}} % a předpokládanou roční změnou hodnoty solární elektřiny o {{priceChange}} %.",
      specificYieldNote:
        "Produkční potenciál je vypočtená výroba na instalovaný kWp v této lokalitě, pro orientaci a sklon vaší střechy. Nejde o celkovou roční výrobu systému.",
      investmentNote:
        "Úroveň investice ukazuje přibližně, jaká investice odpovídá zvolené době návratnosti podle kumulované ekonomické hodnoty výpočtu do daného roku. Není to odhad tržní ceny ani nabídka.",
      ...
      lifetimeInvestmentLink:
        "Kumulovaná ekonomická hodnota do roku {{years}} je základem pro úroveň investice přibližně {{amount}} - jde o stejný výpočet, jen zaokrouhlený.",
      annualValue: "Ekonomická hodnota, rok 1",
      savings30: "Kumulovaná ekonomická hodnota za {{years}} let",
      savings30Method:
        "Období výpočtu: {{years}} let. Degradace výroby: {{degradation}} %/rok. Změna ceny elektřiny: {{priceChange}} %/rok.",
      savings30Note:
        "Dlouhodobá ekonomická hodnota je vypočítána rok po roce s {{degradation}} % roční degradací výroby. Výpočet předpokládá nezměněné hodnoty pro vlastní spotřebu a prodanou solární energii.",
      ...
      balanceNote:
        "Roční výroba odpovídá přibližně {{percent}} % vaší roční spotřeby elektřiny. To neznamená, že veškerá vyrobená elektřina může být přímo spotřebována v nemovitosti, protože výroba a spotřeba probíhají v různých časech.",
      perYearShort: "za rok",
      ...
      priceChangeNoteFlat:
        "Výpočet po celé období používá neměnné hodnoty pro vlastní spotřebu a přebytky solární energie dodané do sítě. Nepředpokládá se žádný nárůst cen, protože budoucí ceny elektřiny nelze předvídat. Pokud ceny porostou, bude hodnota vyšší než v tomto reportu; pokud klesnou, bude nižší.",
      priceChangeNoteTrend:
        "Výpočet předpokládá, že hodnota vlastní spotřeby a přebytků solární energie dodané do sítě se po celé období mění o {{priceChange}} % ročně. Jde o předpoklad, protože budoucí ceny elektřiny nelze předvídat. Odlišný vývoj znamená vyšší nebo nižší výsledek, než je uvedeno v tomto reportu.",
      gridMethodNoteDynamic:
        "Teoretický AC výkon vychází z vámi zvoleného připojení: {{phases}}fázové, {{voltage}} V, vypočteno jako {{factor}} × {{voltage}} V × hlavní jistič. Skutečně povolený výkon připojení nebo dodávky může být omezen distributorem nebo konkrétní instalací.",
    },
  ...
  paywall: {
    ...
    retry:
      "Nákup se teď nepodařilo potvrdit. Nic není ztraceno — automaticky se odemkne, jakmile bude připojení opět fungovat.",
    appOnly:
