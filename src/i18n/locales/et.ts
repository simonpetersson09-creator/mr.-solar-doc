export const et = {
  ...
  "welcome": {
    "title": "Tere tulemast Mr. Solar Doc juurde",
  ...
  "result": {
    ...
    "paybackScenariosHelp": "Lühem tasuvusaeg tähendab väiksemat võimalikku investeeringut. Siin näed, kuidas investeeringu tase muutub, kui nõustud lühema või pikema tasuvusajaga.",
    ...
    "productionCostInfo": "Arv põhineb maksimaalsel investeeringul, mis sobib valitud tasuvusajaga, jagatuna kogu elektrile, mida süsteem arvestusperioodil eeldatavasti toodab. See ei ole paigalduse turuhind.",
    ...
    "selfConsumptionEstimatedHelp": "Hinnatud teie elektritarbimise ja süsteemi arvutatud toodangu põhjal. Saate väärtust käsitsi muuta.",
  ...
  "report": {
    "fields": {
      ...
      "lifetimeNote": "Arvutus näitab hinnangulist arengut {{years}} aasta jooksul arvutatud toodangu, eeldatava degradatsiooni ja valitud elektrihinna arengu põhjal. Tegelik majanduslik tulemus ja toodang võivad ajas erineda.",
      "yearShort": "Aasta",
      "reportId": "Aruande ID",
