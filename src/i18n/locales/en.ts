...
systemSizeInfo: "The calculation is an estimate and should be used as guidance. Actual production, self-consumption, electricity price, compensation, installation cost and financial outcome may differ. The result does not constitute a quote or guarantee.",
  ...
  report: {
    fields: {
      ...
      gridConnectionValue: "{{voltage}} V, {{phases}}-phase",
      gridMethodNote:
        "Theoretical AC power is based on 400 V three-phase, calculated as √3 × 400 V × main fuse. The actual permitted connection or feed-in power may be limited by the grid operator or by the specific installation.",
