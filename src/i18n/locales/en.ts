export const en = {
  ...
  fuse: {
    ...
    disclaimer:
      "The theoretical power of the main fuse is calculated from a 400 V three-phase connection. Check your actual grid connection if you are unsure. Check your actual grid connection if you are unsure.",
    grid: {
  ...
  result: {
    ...
    pvLimitLabel: "Allowed PV power (AC)",
    bindingLimitLabel: "Limited by",
    bindingConnectionCapacity: "Connection capacity",
    bindingPvRule: "National PV rule",
    bindingCapacityShare: "Share of connection capacity",
    bindingBusbar: "Busbar/backfeed rule",
    reasonPvRuleLimit: "The system size is set by your country's PV connection rule, not by the main fuse.",
    reasonBusbarLimit: "The system size is set by the busbar/backfeed rule for your service panel, not by the main fuse.",
    simplifiedProcessNote: "Systems above {{limit}} kW fall outside the simplified connection process. The system is still possible, but normally requires an application and approval from your grid operator.",
