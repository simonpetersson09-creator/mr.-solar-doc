export const nl = {
  ...
  consumption: {
    validation: {
      ...
      monthOutOfRange: "Eén maand is veel hoger dan de andere. Controleer je maandwaarden voordat je verdergaat.",
      monthUneven: "Eén maand wijkt af van de rest. Controleer deze nog eens als dat niet klopt.",
    },
    shape: {
  ...
  result: {
    ...
    revisionUsed: "Je wijziging is inbegrepen bij je aankoop. Nog {{left}} wijziging(en) over binnen 24 uur.",
    revisionsLeft: "Je kunt deze berekening nog {{left}} keer wijzigen binnen 24 uur na aankoop.",
    calculationUnavailable:
      "De berekening kon niet worden voltooid. Controleer de dakgegevens en probeer het opnieuw.",
  ...
  meta: {
    ...
    paywall: {
      title: "Ontgrendel je berekening - Mr. Solar Doc",
      description:
        "Ontgrendel je zonneberekening met een eenmalige aankoop, of neem Premium voor onbeperkte berekeningen.",
      ogDescription: "Ontgrendel de volledige zonneberekening en het PDF-rapport.",
    },
  },
  months: {
  ...
  report: {
    ...
    installerChecklistTitle: "Te bespreken met je installateur",
    installerChecklistItems: [
      "Bevestig ter plaatse de oriëntatie, hellingshoek en eventuele schaduw van het dak.",
      "Houd er rekening mee dat de systeemgrootte mogelijk moet worden aangepast op basis van de werkelijke omstandigheden van het dak, zoals schoorstenen, ventilatiepijpen of beperkt bruikbaar oppervlak.",
      "Controleer de hoofdzekering en de aansluitvoorwaarden bij je netbeheerder.",
      "Bevestig dat het omvormervermogen van {{acPower}} past bij je elektrische aansluiting.",
      "Vergelijk de door de installateur geschatte jaarlijkse opbrengst met de {{production}} uit dit rapport. Schattingen kunnen verschillen afhankelijk van omstandigheden en berekeningsmethode.",
      "Vraag of de omvormer voorbereid is op toekomstige batterijopslag, als dat relevant kan worden.",
      "Zorg dat de meterkast en de bestaande elektrische installatie geschikt zijn voor de installatie.",
      "Bespreek wat is inbegrepen in de offerte, bijvoorbeeld bekabeling, montage, beveiliging en ander installatiemateriaal.",
      "Vraag wie verantwoordelijk is voor eventuele schade aan het dak tijdens de installatie.",
      "Bespreek opbrengstmonitoring, garanties en service.",
      "Vraag een offerte op basis van de dimensionering uit dit rapport: {{kwp}} · {{production}}.",
      "Vergelijk de offerteprijs met het berekende niveau van {{investment}} uit dit rapport. De prijs kan verschillen afhankelijk van apparatuur, installatieomstandigheden en wat is inbegrepen in de levering.",
    ],
