export const nl = {
  ...
  result: {
    ...
    investmentLevelNote:
      "Met de huidige berekeningsaannames komt {{years}} jaar eenvoudige terugverdientijd overeen met een investering van ongeveer {{amount}}.",
    quoteToggle: "Vergelijken met een offerteprijs",
    quoteLabel: "Offerteprijs ({{currency}})",
    quotePlaceholder: "89000",
    quoteResult: "De offerteprijs komt overeen met ongeveer {{years}} jaar eenvoudige terugverdientijd",
    quoteNote:
    ...
    paybackInfo:
      "De eenvoudige terugverdientijd laat zien met hoeveel jaar de geschatte jaarlijkse economische waarde overeenkomt met de investering. Toekomstige elektriciteitsprijswijzigingen, financieringskosten, inflatie, onderhoud of contante waarde worden niet meegenomen.",
    ...
    maxInvestmentExplainer:
      "Om ongeveer {{years}} jaar eenvoudige terugverdientijd te bereiken, mag de installatie hooguit ongeveer {{amount}} kosten.",
    maxInvestmentNote:
  ...
  report: {
    fields: {
      ...
      annualValue: "Geschatte economische waarde",
      savings30: "Totale economische waarde over {{years}} jaar",
      ...
      paybackTime: "Gekozen eenvoudige terugverdientijd",
      address: "Adres",
      coordinates: "Coördinaten",
      ...
      annualProduction: "Elektriciteit per jaar",
      specificYield: "Locatiespecifieke opbrengst",
      ...
      totalAnnualBenefit: "Geschatte economische waarde",
      currency: "Valuta",
      economicValue: "Basiseconomische waarde",
      orientation: "Oriëntatie",
      ...
      quotePayback: "Eenvoudige terugverdientijd op basis van de offerteprijs",
    ...
    origin: {
      user: "Door jou opgegeven",
      calculated: "Berekend door de app",
      assumed: "Aanname (standaardwaarde)",
