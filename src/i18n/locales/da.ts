export const da = {
  ...
  consumption: {
    validation: {
      ...
      monthOutOfRange: "En måned er langt højere end de andre. Tjek dine månedlige værdier, før du fortsætter.",
      monthUneven: "En måned skiller sig ud fra de øvrige. Dobbelttjek den, hvis det ikke er korrekt.",
    },
    shape: {
  ...
  meta: {
    ...
    paywall: {
      title: "Lås din beregning op - Mr. Solar Doc",
      description:
        "Lås din solcelleberegning op med et engangskøb, eller få Premium til ubegrænsede beregninger.",
      ogDescription: "Lås den fulde solcelleberegning og PDF-rapporten op.",
    },
  },
  months: {
  ...
  report: {
    ...
    generated: "Genereret",
    installerChecklistTitle: "Til gennemgang med din installatør",
    installerChecklistItems: [
      "Bekræft tagets retning, hældning og eventuel skygge på stedet.",
      "Vær opmærksom på, at anlæggets størrelse kan skulle justeres ud fra tagets faktiske forhold, f.eks. skorstene, udluftninger eller begrænset brugbart areal.",
      "Tjek hovedsikringen og tilslutningsvilkårene med dit netselskab.",
      "Bekræft, at inverterens effekt på {{acPower}} passer til din eltilslutning.",
      "Sammenlign installatørens estimerede årlige produktion med denne rapports {{production}}. Estimater kan variere afhængigt af forhold og beregningsmetode.",
      "Spørg, om inverteren er forberedt til fremtidig batterilagring, hvis det kan blive relevant.",
      "Sørg for, at eltavlen og den eksisterende elinstallation er egnet til installationen.",
      "Gennemgå, hvad der er inkluderet i tilbuddet, f.eks. kabling, montering, beskyttelse og andet installationsmateriale.",
      "Spørg, hvem der er ansvarlig for eventuelle skader på taget under installationen.",
      "Gennemgå produktionsovervågning, garantier og service.",
      "Bed om et tilbud baseret på denne rapports dimensionering: {{kwp}} · {{production}}.",
      "Sammenlign det tilbudte pris med denne rapports beregnede niveau på {{investment}}. Prisen kan variere afhængigt af udstyr, installationsforhold og hvad der er inkluderet i leverancen.",
    ],
