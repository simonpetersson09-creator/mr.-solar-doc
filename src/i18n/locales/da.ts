export const da = {
  ...
  "welcome": {
    "title": "Mr. Solar Doc",
    "subtitle": "Find ud af, hvilket solcelleanlæg der passer til din bolig, og hvad det kan koste.",
    "body1": "Vi bruger din bolig, dit elforbrug og de lokale solforhold til at beregne en passende anlægsstørrelse og forventet produktion.",
    "body2": "Du vælger en tilbagebetalingstid, der føles rigtig for dig. Mr. Solar Doc beregner derefter den maksimale pris, anlægget kan have for at nå denne tilbagebetalingstid.",
    "disclaimer": "Resultatet er vejledende og ikke et tilbud. De faktiske priser, produktion og økonomiske resultat kan variere afhængigt af installation, elpriser og markedsforhold.",
  ...
  "result": {
    ...
    "paybackSubtitle": "Se hvilket investeringsniveau, der svarer til forskellige tilbagebetalingstider.",
    ...
    "investmentLevelNote": "Med dagens kalkulationsantagelser svarer {{years}} års tilbagebetalingstid til en investering på cirka {{amount}}.",
    ...
    "paybackScenariosHelp": "Kortere tilbagebetalingstid betyder en lavere mulig investering. Her ser du, hvordan investeringsniveauet ændrer sig, hvis du accepterer en kortere eller længere tilbagebetalingstid.",
    "paybackInfo": "Investeringsniveauet viser omtrent, hvilken investering der svarer til den valgte tilbagebetalingstid, baseret på de økonomiske værdier, som beregningen forudser over den periode. Det er ikke en anslået markedspris eller et tilbud.",
    ...
    "productionCostInfo": "Tallet bygger på den maksimale investering, der passer til din valgte tilbagebetalingstid, fordelt på al den strøm anlægget forventes at producere i beregningsperioden. Det er ikke en markedspris for installationen.",
    "maxInvestmentExplainer": "For at nå cirka {{years}} års tilbagebetalingstid bør installationen højst koste omkring {{amount}}.",
    ...
    "selfConsumptionEstimatedHelp": "Estimeret ud fra dit elforbrug og anlæggets beregnede produktion. Du kan justere værdien manuelt.",
  ...
  "report": {
    "fields": {
      ...
      "lifetimeNote": "Beregningen viser den anslåede udvikling over {{years}} år ud fra anlæggets beregnede produktion, antaget degradering og valgt elprisudvikling. Faktisk økonomisk resultat og produktion kan afvige over tid.",
      "yearShort": "År",
      "reportId": "Rapport-ID",
      ...
      "summaryMethodFlat": "Beregnet med {{degradation}} % årlig produktionsdegradering og uændrede værdier for egenanvendt og solgt solel.",
      "summaryMethodTrend": "Beregnet med {{degradation}} % årlig produktionsdegradering og en antaget årlig ændring på {{priceChange}} % i værdien af solel.",
      "specificYieldNote": "Stedspecifikt udbytte er det beregnede udbytte per installeret kWp på dette sted, ud fra dit tags orientering og hældning. Det er ikke anlæggets samlede årlige produktion.",
      "investmentNote": "Investeringsniveauet viser omtrent, hvilken investering der svarer til den valgte tilbagebetalingstid, baseret på den akkumulerede økonomiske værdi, som beregningen forudser frem til det år. Det påvirkes af den antagne ændring i elværdien og af produktionsdegradering, og er ikke en anslået markedspris eller et tilbud.",
      ...
      "lifetimeInvestmentLink": "Den akkumulerede økonomiske værdi frem til år {{years}} er det, investeringsniveauet på omkring {{amount}} er baseret på - det er den samme beregning, blot afrundet.",
