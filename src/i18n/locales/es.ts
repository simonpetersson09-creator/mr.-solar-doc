export const es = {
  ...
  consumption: {
    validation: {
      ...
      monthOutOfRange: "Un mes es mucho más alto que los demás. Revisa tus valores mensuales antes de continuar.",
      monthUneven: "Un mes se destaca del resto. Vuelve a comprobarlo si no es correcto.",
    },
    shape: {
  ...
  result: {
    ...
    loadProfileNote: "Supuesto estándar, no consumo medido ni simulación horaria.",
    loadProfileLabel: "Patrón de consumo",
    loadProfile: {
      evening: "Mañana y tarde-noche",
      eveningHelp: "Normalmente fuera durante el día.",
      mixed: "Mixto",
    ...
    selfConsumptionModeAuto: "Estimado automáticamente",
    selfConsumptionModeManual: "Introducido manualmente",
    selfConsumptionManualHelp:
      "Has introducido el autoconsumo tú mismo. Restablece la estimación automática si quieres que la aplicación lo calcule.",
    selfConsumptionResetAuto: "Restablecer la estimación automática",
    selfConsumptionManualProfileNote:
      "El perfil de consumo no afecta al autoconsumo cuando lo introduces manualmente.",
    ...
    selfConsumptionCappedMonthlyNote:
      "El autoconsumo se ha limitado al {{effective}} % (elegiste {{requested}} %), porque en algunos meses la producción supera tu consumo de ese mes. El excedente no puede pasar a otro mes sin batería.",
    selfConsumptionCappedMonthlyModelledNote:
      "El autoconsumo se ha limitado al {{effective}} % (elegiste {{requested}} %) con un perfil mensual estimado. El límite depende de esa estimación y no es un límite seguro para tu hogar.",
    shadingNotIncludedNote:
      "El sombreado local de árboles, edificios o chimeneas no está incluido en el cálculo.",
    clippingModelledNote:
      "El límite de potencia del inversor elimina el {{loss}} % de la producción anual (datos horarios de {{source}}, {{year}}).",
    clippingNotModelledNote:
      "No se pudo calcular el límite de potencia del inversor para esta instalación, por lo que el recorte posible no se incluye en las cifras de producción.",
    minimumSizeNote:
    ...
    revisionUsed: "Tu cambio está incluido en tu compra. Quedan {{left}} cambio(s) dentro de 24 horas.",
    revisionsLeft: "Puedes cambiar este cálculo {{left}} vez/veces más dentro de las 24 horas posteriores a la compra.",
    calculationUnavailable:
      "No se pudo completar el cálculo. Revisa los detalles del tejado e inténtalo de nuevo.",
  ...
  meta: {
    ...
    paywall: {
      title: "Desbloquea tu cálculo - Mr. Solar Doc",
      description:
        "Desbloquea tu cálculo solar con una compra única, o consigue Premium para cálculos ilimitados.",
      ogDescription: "Desbloquea el cálculo solar completo y el informe en PDF.",
    },
  },
  months: {
  ...
  report: {
    ...
    generated: "Generado",
    installerChecklistTitle: "Para tratar con tu instalador",
    installerChecklistItems: [
      "Confirma in situ la orientación, la inclinación y cualquier sombra sobre el tejado.",
      "Ten en cuenta que el tamaño del sistema puede necesitar ajustarse según las condiciones reales del tejado, como chimeneas, respiraderos o superficie útil limitada.",
      "Comprueba el fusible principal y las condiciones de conexión con tu operador de red.",
      "Confirma que la potencia del inversor de {{acPower}} es adecuada para tu conexión eléctrica.",
      "Compara la producción anual estimada por el instalador con la {{production}} de este informe. Las estimaciones pueden variar según las condiciones y el método de cálculo.",
      "Pregunta si el inversor está preparado para un futuro almacenamiento con batería, por si eso resulta relevante.",
      "Asegúrate de que el cuadro eléctrico y la instalación eléctrica existente son adecuados para la instalación.",
      "Revisa qué incluye el presupuesto, por ejemplo cableado, montaje, protecciones y otros materiales de instalación.",
      "Pregunta quién es responsable de cualquier daño al tejado durante la instalación.",
      "Revisa el seguimiento de la producción, las garantías y el servicio.",
      "Solicita un presupuesto basado en el dimensionamiento de este informe: {{kwp}} · {{production}}.",
      "Compara el precio del presupuesto con el nivel calculado de {{investment}} en este informe. El precio puede variar según el equipo, las condiciones de instalación y lo que se incluya en la entrega.",
    ],
