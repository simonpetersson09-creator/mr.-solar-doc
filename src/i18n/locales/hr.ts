export const hr = {
  ...
  result: {
    ...
    productionCostTitle: "Koliko košta solarna energija s vašeg krova?",
    ...
    productionCostInfo: "Trošak proizvodnje je izračunati prosječni trošak po proizvedenom kWh tijekom životnog vijeka instalacije. Na stvarni trošak mogu utjecati proizvodnja, degradacija, održavanje i drugi budući troškovi.",
    productionCostExplainer: "Trošak sustava dijelimo s procijenjenom proizvodnjom tijekom cijelog razdoblja izračuna.",
    productionCostLabel: "Trošak proizvodnje",
    ...
    productionCostUnavailable: "Trenutno ne možemo izračunati trošak proizvodnje s dostupnim podacima.",
    perKwh: "{{amount}}/kWh",
