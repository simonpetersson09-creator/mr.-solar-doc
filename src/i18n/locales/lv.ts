export const lv = {
  ...
  "welcome": {
    ...
    "point1Title": "Pielāgots jūsu īpašumam",
    "point1Body": "Rēķinām, ņemot vērā elektrības patēriņu, saules apstākļus un pieslēgumu.",
    "point2Title": "Pareizais sistēmas izmērs",
    "point2Body": "Saņemat ieteicamo jaudu un aprēķināto gada izstrādi.",
    "point3Title": "Jūs izvēlaties atmaksāšanās laiku",
    "point3Body": "Aprēķinām, cik daudz sistēma drīkst maksāt, lai sasniegtu izvēlēto atmaksāšanās laiku.",
    "point4Title": "Skaidrs pārskats",
    "point4Body": "Rezultātu saņemat pārskatā, kas palīdz izvērtēt ieguldījumu saules enerģijā.",
  ...
  "result": {
    ...
    "investmentLevelNote": "Ar šodienas aprēķinu pieņēmumiem {{years}} gadu atmaksas periods atbilst investīcijai aptuveni {{amount}} apmērā.",
    ...
    "paybackScenariosHelp": "Īsāks atmaksāšanās laiks nozīmē zemāku iespējamo ieguldījumu. Šeit redzi, kā ieguldījuma līmenis mainās, ja pieņem īsāku vai garāku atmaksāšanās laiku.",
    "paybackInfo": "Atmaksas periods parāda, cik gados aprēķinātā gada ekonomiskā vērtība atbilst investīcijai. Aprēķins neņem vērā, piemēram, nākotnes elektroenerģijas cenu izmaiņas, finansēšanas izmaksas, inflāciju, uzturēšanu vai diskontēšanu.",
    ...
    "productionCostInfo": "Skaitlis balstās uz maksimālo ieguldījumu, kas atbilst izvēlētajam atmaksāšanās laikam, sadalot to uz visu elektroenerģiju, ko sistēma varētu saražot aprēķina periodā. Tā nav uzstādīšanas tirgus cena.",
    "maxInvestmentExplainer": "Lai sasniegtu aptuveni {{years}} gadu atmaksas periodu, instalācijai vajadzētu maksāt ne vairāk kā aptuveni {{amount}}.",
    ...
    "selfConsumptionEstimatedHelp": "Novērtēts, balstoties uz jūsu elektroenerģijas patēriņu un sistēmas aprēķināto ražošanu. Vērtību var pielāgot manuāli.",
  ...
  "report": {
    "fields": {
      ...
      "lifetimeNote": "Aprēķins parāda paredzamo attīstību {{years}} gados, pamatojoties uz aprēķināto ražošanu, pieņemto degradāciju un izvēlēto elektroenerģijas cenu attīstību. Faktiskais ekonomiskais rezultāts un ražošana laika gaitā var atšķirties.",
      "yearShort": "Gads",
      ...
      "summaryMethodFlat": "Aprēķināts ar gada ražošanas degradāciju {{degradation}} % un nemainīgām pašpatērētās un pārdotās saules elektroenerģijas vērtībām.",
      "summaryMethodTrend": "Aprēķināts ar gada ražošanas degradāciju {{degradation}} % un pieņemtu {{priceChange}} % gada saules elektroenerģijas vērtības izmaiņu.",
      "specificYieldNote": "Ražošanas potenciāls ir šīs vietas aprēķinātā izstrāde uz uzstādīto kWp jūsu jumta orientācijai un slīpumam. Tā nav sistēmas kopējā gada izstrāde.",
      "investmentNote": "Investīciju līmenis rāda aptuveni, kāda investīcija atbilst izvēlētajam atmaksāšanās laikam, balstoties uz aprēķina uzkrāto ekonomisko vērtību līdz tam gadam. Tas nav tirgus cenas novērtējums vai piedāvājums.",
      ...
      "lifetimeInvestmentLink": "Uzkrātā ekonomiskā vērtība līdz {{years}}. gadam ir pamats investīciju līmenim aptuveni {{amount}} - tas ir tas pats aprēķins, tikai noapaļots.",
