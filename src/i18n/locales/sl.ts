export const sl = {
  ...
  "welcome": {
    ...
    "point1Title": "Prilagojeno vaši nepremičnini",
    "point1Body": "Računamo s porabo elektrike, sončnimi razmerami in vašim priključkom.",
    "point2Title": "Prava velikost sistema",
    "point2Body": "Dobite priporočeno moč in izračunano letno proizvodnjo.",
    "point3Title": "Vi izberete vračilno dobo",
    "point3Body": "Izračunamo, koliko sme sistem največ stati, da doseže izbrano vračilno dobo.",
    "point4Title": "Jasno poročilo",
    "point4Body": "Rezultat dobite v poročilu, ki vam pomaga oceniti naložbo v sončno elektrarno.",
  ...
  "result": {
    ...
    "paybackScenariosHelp": "Krajša doba vračila pomeni nižjo možno naložbo. Tukaj vidite, kako se raven naložbe spremeni, če sprejmete krajšo ali daljšo dobo vračila.",
    ...
    "productionCostInfo": "Znesek temelji na najvišji naložbi, ki ustreza izbrani dobi vračila, porazdeljeni na vso elektriko, ki naj bi jo sistem proizvedel v obdobju izračuna. To ni tržna cena namestitve.",
    ...
    "selfConsumptionEstimatedHelp": "Ocenjeno na podlagi vaše porabe elektrike in izračunane proizvodnje sistema. Vrednost lahko ročno prilagodite.",
  ...
  "report": {
    "fields": {
      ...
      "lifetimeNote": "Izračun prikazuje ocenjeni razvoj v {{years}} letih na podlagi izračunane proizvodnje, predpostavljene degradacije in izbranega gibanja cen elektrike. Dejanski ekonomski izid in proizvodnja lahko sčasoma odstopata.",
      "yearShort": "Leto",
      ...
      "summaryMethodFlat": "Izračunano z letno degradacijo proizvodnje {{degradation}} % in nespremenjenimi vrednostmi lastne porabe in prodane sončne elektrike.",
      "summaryMethodTrend": "Izračunano z letno degradacijo proizvodnje {{degradation}} % in predvideno letno spremembo vrednosti sončne elektrike za {{priceChange}} %.",
      "specificYieldNote": "Potencial proizvodnje je izračunana proizvodnja na nameščen kWp na tej lokaciji, za usmerjenost in naklon vaše strehe. Ni skupna letna proizvodnja sistema.",
      "investmentNote": "Raven naložbe pokaže približno, kakšna naložba ustreza izbrani dobi vračila glede na kumulativno ekonomsko vrednost izračuna do tistega leta. Ni ocena tržne cene niti ponudba.",
      ...
      "lifetimeInvestmentLink": "Kumulativna ekonomska vrednost do leta {{years}} je osnova za raven naložbe približno {{amount}} - gre za isti izračun, le zaokrožen.",
