export const it = {
  ...
  address: {
    ...
    marketUnsupported:
      "Mr. Solar Doc non supporta ancora questo paese. Scegli un indirizzo in un paese supportato per continuare.",
  ...
  roof: {
    ...
    unit: "kWh/kWp/anno",
    error:
      "Non è stato possibile recuperare i dati di produzione solare per questo sito al momento. Nessun valore viene stimato.",
    errorOverSea:
  ...
  consumption: {
    validation: {
      ...
      monthOutOfRange: "Un mese è molto più alto degli altri. Controlla i tuoi valori mensili prima di continuare.",
      monthUneven: "Un mese si distingue dagli altri. Ricontrollalo se non è corretto.",
    },
    shape: {
      ...
      defaultNote:
        "Utilizziamo una ripartizione normale stimata del tuo consumo annuo. Puoi modificarlo in seguito.",
      even: {
    ...
    upload: {
      ...
      error:
        "Non siamo riusciti a trovare alcun consumo nel documento. Inserisci i valori manualmente.",
      fileTypes: "PDF, XLSX, XLS, CSV, TXT o immagine (PNG, JPEG)",
      sectionTitle: "Scansiona la tua bolletta",
      sectionHint:
        "Allega la bolletta o i dati di consumo di 12 mesi e compileremo noi i valori per te.",
    ...
    manual: {
      ...
      sectionHint:
        "Inserisci il tuo consumo annuo — controlla la bolletta o il contratto elettrico.",
    },
  ...
  fuse: {
    ...
    capacity: {
      ...
      service: {
        title: "Dimensione dell'allacciamento elettrico",
        label: "Dimensione dell'allacciamento elettrico",
        help: "Trova l'amperaggio sull'interruttore generale o nel quadro elettrico.",
      },
      "contracted-kva": {
    ...
    grid: {
      ...
      unverifiedHint:
        "Non abbiamo valori di rete verificati per questo paese. Controlla i tuoi dati sul contatore o sul quadro elettrico.",
    },
    title: "Qual è la potenza del tuo limitatore di potenza?",
    subtitle:
      "Il limitatore di potenza serve a stimare quale inverter può essere normalmente collegato. La potenza effettivamente consentita è determinata dal gestore di rete.",
    ...
    noCountryOptions:
      "Non abbiamo ancora opzioni di allacciamento verificate per questo paese. Inserisci l'interruttore generale in ampere e modifica le impostazioni di rete qui sotto se necessario.",
    unverifiedCountryNotice:
      "Non abbiamo verificato lo standard di rete di questo paese. Controlla tensione, fasi e potenza di allacciamento sulla bolletta o presso il tuo distributore, poi conferma qui sotto.",
  ...
  result: {
    ...
    calculationUnavailable:
      "Non è stato possibile completare il calcolo. Controlla i dati del tetto e riprova.",
    connection: {
    ...
    estimatedConsumptionNote:
      "Il consumo mensile è stimato dal tuo valore annuo e dal profilo scelto.",
    ...
    coverageNote:
      "Questo valore confronta la produzione annua totale con il consumo annuo totale. Non è un indicatore di autosufficienza.",
    ...
    priceScenarioHint:
      "Un'ipotesi sulla variazione annua, non una previsione. Il prezzo viene aumentato anno dopo anno per tutto il periodo di calcolo.",
    ...
    standardValueHint:
      "Valori standard per il calcolo. Modificali con i valori del tuo contratto di fornitura elettrica per un risultato più individuale.",
    exportValueInfo:
      "Inserisci la compensazione totale per kWh per l'elettricità che immetti in rete, inclusi eventuali benefici di rete o altre compensazioni legate all'esportazione.",
    editable: "Modificabile",
    editableTooltip: "Modifica ipotesi",
    fuseLimit: "Limite di potenza teorico dal limitatore di potenza",
    fuseLimitInfo:
      "Calcolato in base al limitatore di potenza e alla tensione di rete. La potenza effettiva consentita dell'inverter o di immissione in rete può essere limitata dal gestore di rete e dalle normative locali.",
    reason: {
      profileUnknown:
        "Il dimensionamento è adattato al tuo consumo elettrico e alla produzione solare stimata.",
      profileNormal:
        "Il dimensionamento è adattato al tuo consumo elettrico e alla produzione solare stimata.",
      profileLowSolarSeason:
        "Una gran parte del tuo consumo elettrico avviene quando la produzione solare è più bassa. Perciò l'impianto non è stato ulteriormente sovradimensionato.",
      profileHighSolarSeason:
        "Consumi relativamente molta elettricità durante i mesi soleggiati. Pertanto, una potenza dei pannelli leggermente superiore rispetto all'inverter può essere appropriata.",
      profileVeryHighSolarSeason:
        "Il tuo consumo elettrico è chiaramente concentrato nei mesi soleggiati. Si suggerisce quindi una potenza dei pannelli superiore rispetto all'inverter.",
      gridLimit:
        "L'impianto è limitato dal tuo limitatore di potenza – la tua connessione alla rete non consente maggiore potenza.",
      minimumSize:
        "Il tuo consumo elettrico è basso, quindi suggeriamo l'impianto più piccolo e sensato.",
      maximumSize: "Il suggerimento è limitato alla dimensione massima che l'app dimensiona.",
    },
    monthlyDataNote:
      "I valori mensili non mostrano se l'elettricità viene utilizzata di giorno o di notte. Vengono quindi utilizzati come indicazione per il dimensionamento, non come prova di quanta energia solare puoi utilizzare tu stesso.",
    ...
    rationale: {
      consumption:
        "Dimensionato per produrre all'incirca la stessa quantità di elettricità che consumi in un anno.",
      gridLimit:
        "L'impianto è limitato dal tuo limitatore di potenza – la tua connessione alla rete non consente maggiore potenza.",
    ...
    selfConsumedValueHelp:
      "L'energia solare autoconsumata sostituisce l'elettricità che altrimenti avresti dovuto acquistare dalla rete.",
    ...
    investmentLevelNote:
      "Con le ipotesi di calcolo odierne, {{years}} anni di tempo di ritorno corrispondono a un investimento di circa {{amount}}.",
    ...
    quoteNote:
      "Il calcolo utilizza la stessa produzione, autoconsumo e prezzi dell'elettricità della tua attuale simulazione.",
    priceExplainer:
      "L'energia solare autoconsumata sostituisce l'elettricità che altrimenti avrebbe dovuto essere acquistata dalla rete. L'energia solare immessa in rete, invece, genera un compenso per l'elettricità immessa nella rete.",
    paybackYears: "{{years}} anni",
    paybackScenariosTitle: "Livello di investimento con diversi tempi di ritorno",
    paybackScenarioSelected: "La tua scelta",
    ...
    investmentLevelInfo:
      "Mostra approssimativamente quale costo di investimento corrisponde al periodo di ammortamento scelto. Non è una stima del costo reale dell'impianto. Il prezzo effettivo dipende, tra l'altro, dal tetto, dall'installazione, dai componenti e dal fornitore.",
    systemSizeInfoLabel: "Maggiori informazioni",
    systemSizeInfo:
      "Il calcolo è una stima e va utilizzato come indicazione. Produzione effettiva, autoconsumo, prezzo dell'energia, compensazione, costo di installazione e risultato economico possono variare. Il risultato non costituisce un'offerta né una garanzia.",
    productionCostInfoLabel: "Maggiori informazioni",
    productionCostInfo:
      "La cifra si basa sull'investimento massimo compatibile con il tempo di ritorno scelto, distribuito su tutta l'energia che l'impianto dovrebbe produrre nel periodo di calcolo. Non è un prezzo di mercato dell'impianto.",
    maxInvestmentExplainer:
      "Per raggiungere circa {{years}} anni di tempo di ritorno, l'installazione dovrebbe costare al massimo circa {{amount}}.",
    maxInvestmentNote:
      "L'importo è un calcolo basato sui tuoi input e sulle ipotesi di calcolo – non un'offerta o una stima del prezzo di mercato.",
    missingMarketValues:
      "Non abbiamo un valore predefinito verificato per questo paese. Inserisci tu stesso i valori di seguito.",
    currency: "Valuta",
    economicValue: "Valore economico di base",
    perYear: "per anno",
    adjustAssumptions: "Modifica le ipotesi",
    adjustAssumptionsHint:
      "Cambia autoconsumo, prezzi dell'elettricità e tempo di ritorno desiderato.",
    ...
    selfConsumptionUserAssumption: "La tua ipotesi",
    ...
    consumptionTooLowNote:
      "Il consumo inserito è molto basso, quindi il risultato è solo indicativo.",
    ...
    limitedByFuse:
      "L'impianto è limitato dal tuo limitatore di potenza, non dal tuo consumo elettrico.",
    ...
    productionCostTitle: "Quanto può costare il kWh solare?",
    productionCostExplainer:
      "Dividiamo il costo dell'impianto per la produzione stimata durante l'intero periodo di calcolo.",
    productionCostLabel: "Può costare",
    ...
    productionCostUnavailable: "Non possiamo calcolarlo con i dati attuali.",
    perKwh: "{{amount}}/kWh",
    ...
    gridTooSmallBody:
      "La tua connessione attuale ({{maxKw}} kW) è troppo piccola per il sistema più piccolo supportato (inverter da {{minKw}} kW). Aumenta il fusibile principale o la potenza contrattuale per continuare.",
    missingSelfConsumedValue:
      "Manca il prezzo dell'elettricità. Inserisci quanto paghi per kWh per vedere il valore dell'autoconsumo solare.",
    missingExportValue:
      "Manca la remunerazione per l'immissione. Inserisci quanto ricevi per kWh immesso per calcolare i ricavi.",
    missingInstallationCost:
      "Manca il costo dell'impianto. Inserisci il tuo preventivo o l'investimento stimato.",
    economicsIncomplete: "Base incompleta",
    enterValues: "Inserisci i valori",
    economicsRequiresPrice:
      "Il calcolo economico richiede un prezzo dell'elettricità. Inserisci i tuoi prezzi per vedere risparmio, tempo di ritorno e costo di produzione.",
    ...
    gridUnverifiedWarning:
      "Le ipotesi di rete si basano su valori generici e devono essere verificate localmente prima dell'installazione.",
    ...
    calcErrorBody:
      "Alcuni dati non permettono il calcolo. Torna indietro e controlla consumi, allacciamento e ipotesi.",
  },
  units: {
    kwhPerYear: "kWh/anno",
    kwhPerKwp: "kWh/kWp",
  ...
  meta: {
    home: {
      ...
      description:
        "Calcola la potenza solare raccomandata, l'inverter e la produzione annuale in base al tuo indirizzo, consumo elettrico e fusibile principale.",
      ogDescription:
        "Calcolo passo dopo passo con dati di localizzazione da PVGIS: kWp, inverter, produzione mensile ed economia.",
    },
    result: {
    ...
    paywall: {
      title: "Sblocca il tuo calcolo - Mr. Solar Doc",
      description:
        "Sblocca il tuo calcolo solare con un acquisto unico, oppure passa a Premium per calcoli illimitati.",
      ogDescription: "Sblocca il calcolo solare completo e il report PDF.",
    },
  },
  months: {
  ...
  report: {
    ...
    fields: {
      ...
      gridConnectionValue: "{{voltage}} V, {{phases}} fasi",
      gridMethodNote:
        "La potenza CA teorica presuppone un allacciamento trifase a 400 V ed è calcolata come 1,73 × 400 V × fusibile principale. La potenza di allacciamento o di immissione effettivamente consentita può essere limitata dal gestore di rete o dall'installazione specifica.",
      gridMethodNoteContracted:
        "La potenza di allacciamento o di immissione effettivamente consentita può essere limitata dal gestore di rete o dall'installazione specifica.",
      savings30Short:
        "Calcolato con {{degradation}} % di degrado annuo della produzione e valori dell'elettricità invariati.",
      ...
      selfConsumptionRateNote:
        "Il tasso di autoconsumo mostra quanta parte dell'elettricità solare prodotta viene utilizzata direttamente nell'immobile.",
      selfSufficiencyRateNote:
        "Il tasso di autosufficienza mostra quanta parte del consumo totale di elettricità dell'immobile è coperta direttamente dall'energia solare.",
      ...
      priceMethodNote:
        "I valori dell'energia sono ipotesi di calcolo. Il valore effettivo dell'energia solare autoconsumata e venduta dipende dal contratto, dagli oneri, dalle tasse, dalle regole e dalle condizioni di mercato.",
      ...
      calculationPeriodNote:
        "Il periodo di calcolo di {{years}} anni è l'arco di tempo coperto e corrisponde a una normale vita tecnica per un impianto fotovoltaico. Tutti gli importi a lungo termine nel rapporto sono la somma dall'anno 1 all'anno {{years}}, con la produzione che diminuisce del {{degradation}} % per anno.",
      ...
      lifetimeNote:
        "Il calcolo mostra lo sviluppo stimato su {{years}} anni in base alla produzione calcolata, alla degradazione ipotizzata e all'andamento del prezzo dell'elettricità scelto. Il risultato economico effettivo e la produzione possono variare nel tempo.",
      yearShort: "Anno",
      reportId: "ID rapporto",
      uncertaintyTitle: "Cosa può influenzare il risultato?",
      uncertaintyText:
        "La produzione solare effettiva e il risultato economico possono differire dal calcolo. Il risultato è influenzato tra l'altro dalle variazioni climatiche, dall'ombreggiamento, dall'orientamento e dall'inclinazione dei pannelli, dal consumo elettrico effettivo e dal momento in cui avviene, dai prezzi dell'elettricità, dal compenso per l'energia venduta e dalle prestazioni dell'impianto nel tempo.",
      panelPower: "Potenza pannello",
      summaryMethodFlat:
        "Calcolato con un degrado annuo della produzione del {{degradation}} % e valori invariati per l'energia solare autoconsumata e venduta.",
      summaryMethodTrend:
        "Calcolato con un degrado annuo della produzione del {{degradation}} % e una variazione annua ipotizzata del {{priceChange}} % nel valore dell'energia solare.",
      specificYieldNote:
        "La produzione specifica del sito è la resa calcolata per kWp installato in questa località, in base all'orientamento e all'inclinazione del tuo tetto. Non è la produzione annua totale dell'impianto.",
      investmentNote:
        "Il livello di investimento mostra approssimativamente quale investimento corrisponde al tempo di ritorno scelto, in base al valore economico accumulato che il calcolo proietta fino a quell'anno. È influenzato dalla variazione ipotizzata del valore dell'elettricità e dal degrado della produzione, e non è un prezzo di mercato stimato o un'offerta.",
      ...
      lifetimeInvestmentLink:
        "Il valore economico accumulato fino all'anno {{years}} è ciò su cui si basa il livello di investimento di circa {{amount}} - è lo stesso calcolo, solo arrotondato.",
      annualValue: "Valore economico, anno 1",
      savings30: "Valore economico accumulato su {{years}} anni",
      savings30Method:
        "Periodo di calcolo: {{years}} anni. Degrado della produzione: {{degradation}} %/anno. Variazione del prezzo dell'elettricità: {{priceChange}} %/anno.",
      savings30Note:
        "Il valore economico a lungo termine è calcolato anno per anno utilizzando il {{degradation}} % di degrado annuo della produzione. Il calcolo assume valori invariati per l'energia solare autoconsumata e immessa in rete.",
      ...
      balanceNote:
        "La produzione annua corrisponde a circa {{percent}} % del tuo consumo annuo di elettricità. Ciò non significa che tutta l'elettricità prodotta possa essere utilizzata direttamente nell'immobile, poiché produzione e consumo avvengono in momenti diversi.",
      perYearShort: "p.a.",
      ...
      gridMethodNoteDynamic:
        "La potenza AC teorica si basa sull'allacciamento scelto: {{phases}} fase/i, {{voltage}} V, calcolata come {{factor}} × {{voltage}} V × interruttore generale. La potenza effettivamente consentita può essere limitata dal distributore o dall'impianto specifico.",
    },
    ...
    generated: "Generato",
    installerChecklistTitle: "Da discutere con il tuo installatore",
    installerChecklistItems: [
      "Conferma sul posto l'orientamento, l'inclinazione ed eventuali ombreggiature del tetto.",
      "Tieni presente che la dimensione dell'impianto potrebbe dover essere adattata in base alle condizioni reali del tetto, come camini, sfiati o superficie utile limitata.",
      "Verifica il fusibile principale e le condizioni di allacciamento con il tuo gestore di rete.",
      "Conferma che la potenza dell'inverter di {{acPower}} sia adatta al tuo allacciamento elettrico.",
      "Confronta la produzione annua stimata dall'installatore con la {{production}} di questo report. Le stime possono variare in base alle condizioni e al metodo di calcolo.",
      "Chiedi se l'inverter è predisposto per un futuro accumulo a batteria, qualora possa diventare rilevante.",
      "Assicurati che il quadro elettrico e l'impianto elettrico esistente siano idonei per l'installazione.",
      "Verifica cosa è incluso nel preventivo, ad esempio cablaggi, montaggio, protezioni e altro materiale di installazione.",
      "Chiedi chi è responsabile per eventuali danni al tetto durante l'installazione.",
      "Discuti il monitoraggio della produzione, le garanzie e l'assistenza.",
      "Richiedi un preventivo basato sul dimensionamento di questo report: {{kwp}} · {{production}}.",
      "Confronta il prezzo del preventivo con il livello calcolato di {{investment}} in questo report. Il prezzo può variare in base all'attrezzatura, alle condizioni di installazione e a ciò che è incluso nella fornitura.",
    ],
  ...
  paywall: {
    ...
    retry:
      "Al momento non siamo riusciti a confermare l'acquisto. Non hai perso nulla — si sbloccherà automaticamente non appena la connessione tornerà disponibile.",
    appOnly:
    ...
    reportInEnglish: "Il report PDF viene fornito in inglese.",
