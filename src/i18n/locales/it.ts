export const it = {
  ...
  "result": {
    ...
    "paybackScenariosHelp": "Un tempo di ritorno più breve significa un investimento possibile più basso. Qui vedi come cambia il livello di investimento se accetti un tempo di ritorno più breve o più lungo.",
    ...
    "productionCostInfo": "La cifra si basa sull'investimento massimo compatibile con il tempo di ritorno scelto, distribuito su tutta l'energia che l'impianto dovrebbe produrre nel periodo di calcolo. Non è un prezzo di mercato dell'impianto.",
    ...
    "selfConsumptionEstimatedHelp": "Stimato in base al tuo consumo elettrico e alla produzione calcolata dell'impianto. Puoi modificare il valore manualmente.",
