export const fr = {
  ...
  consumption: {
    validation: {
      ...
      monthOutOfRange: "Un mois est nettement plus élevé que les autres. Vérifiez vos valeurs mensuelles avant de continuer.",
      monthUneven: "Un mois se démarque des autres. Vérifiez-le si cela ne semble pas correct.",
    },
    shape: {
      question:
...
evenHelp: "Consommation à peu près identique jour et nuit.",
  ...
  meta: {
    ...
    paywall: {
      title: "Débloquez votre calcul - Mr. Solar Doc",
      description:
        "Débloquez votre calcul solaire avec un achat unique, ou passez à Premium pour des calculs illimités.",
      ogDescription: "Débloquez le calcul solaire complet et le rapport PDF.",
    },
  },
  months: {
  ...
  report: {
    ...
    generated: "Généré",
    installerChecklistTitle: "À aborder avec votre installateur",
    installerChecklistItems: [
      "Confirmez sur place l'orientation, l'inclinaison et les éventuelles ombres portées sur le toit.",
      "Notez que la taille du système peut devoir être ajustée en fonction des conditions réelles du toit, comme les cheminées, les conduits d'aération ou une surface utile limitée.",
      "Vérifiez le fusible principal et les conditions de raccordement avec votre gestionnaire de réseau.",
      "Confirmez que la puissance de l'onduleur de {{acPower}} convient à votre raccordement électrique.",
      "Comparez la production annuelle estimée par l'installateur avec les {{production}} de ce rapport. Les estimations peuvent varier selon les conditions et la méthode de calcul.",
      "Demandez si l'onduleur est prévu pour un futur stockage par batterie, si cela peut devenir pertinent.",
      "Assurez-vous que le tableau électrique et l'installation existante conviennent à l'installation.",
      "Passez en revue ce qui est inclus dans le devis, par exemple le câblage, le montage, la protection et autre matériel d'installation.",
      "Demandez qui est responsable en cas de dommage au toit pendant l'installation.",
      "Passez en revue le suivi de production, les garanties et le service.",
      "Demandez un devis basé sur le dimensionnement de ce rapport : {{kwp}} · {{production}}.",
      "Comparez le prix du devis avec le niveau calculé de {{investment}} dans ce rapport. Le prix peut varier selon l'équipement, les conditions d'installation et ce qui est inclus dans la livraison.",
    ],
