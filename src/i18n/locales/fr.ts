export const fr = {
  ...
  "welcome": {
    "title": "Mr. Solar Doc",
    "subtitle": "De quelle taille d'installation solaire avez-vous besoin et quelle valeur a-t-elle pour vous ?",
  ...
  "result": {
    ...
    "paybackScenariosHelp": "Un temps de retour plus court implique un investissement possible plus faible. Vous voyez ici comment le niveau d'investissement évolue si vous acceptez un temps de retour plus court ou plus long.",
    ...
    "productionCostInfo": "Le chiffre repose sur l'investissement maximal compatible avec votre temps de retour choisi, réparti sur toute l'électricité que l'installation devrait produire sur la période de calcul. Ce n'est pas un prix de marché de l'installation.",
    ...
    "selfConsumptionEstimatedHelp": "Estimée à partir de votre consommation d'électricité et de la production calculée de l'installation. Vous pouvez ajuster la valeur manuellement.",
