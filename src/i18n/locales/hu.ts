export const hu = {
  ...
  result: {
    ...
    productionCostTitle: "Mennyibe kerül a tetejéről származó napenergia?",
    ...
    productionCostInfo: "A termelési költség a kitermelt kWh-nkénti számított átlagköltség a rendszer élettartama alatt. A tényleges költséget befolyásolhatja a termelés, a degradáció, a karbantartás és egyéb jövőbeli költségek.",
    productionCostExplainer: "A rendszer költségét elosztjuk a teljes számítási időszakra becsült termeléssel.",
    productionCostLabel: "Termelési költség",
    ...
    productionCostUnavailable: "A jelenlegi adatokkal nem tudjuk kiszámítani a termelési költséget.",
    perKwh: "{{amount}}/kWh",
