export const de = {
  ...
  address: {
    ...
    mapHint:
      "Tippen Sie auf die Karte, um die Immobilie zu markieren – die Adresse wird automatisch ausgefüllt.",
    searching: "Sucht…",
    ...
    marketUnsupported:
      "Mr. Solar Doc unterstützt dieses Land noch nicht. Wählen Sie eine Adresse in einem unterstützten Land, um fortzufahren.",
  ...
  roof: {
    ...
    unit: "kWh/kWp/Jahr",
    error:
      "Wir konnten die Solarertragsdaten für diesen Standort derzeit nicht abrufen. Es werden keine Werte geschätzt.",
    errorOverSea:
  ...
  consumption: {
    ...
    shape: {
      ...
      defaultNote:
        "Wir verwenden eine normale geschätzte Verteilung Ihres Jahresverbrauchs. Sie können dies später ändern.",
      even: {
    ...
    upload: {
      ...
      error:
        "Wir konnten keinen Verbrauch im Dokument finden. Bitte geben Sie die Werte manuell ein.",
      fileTypes: "PDF, XLSX, XLS, CSV, TXT oder Bild (PNG, JPEG)",
      sectionTitle: "Stromrechnung scannen",
      sectionHint:
        "Hängen Sie Ihre Stromrechnung oder Verbrauchsdaten für 12 Monate an, und wir füllen die Werte automatisch für Sie aus.",
    ...
    manual: {
      ...
      sectionHint:
        "Gib deinen Jahresverbrauch ein — prüfe deine Stromrechnung oder deinen Vertrag.",
    },
  ...
  fuse: {
    ...
    grid: {
      ...
      unverifiedHint:
        "Für dieses Land liegen uns keine verifizierten Netzwerte vor. Bitte prüfen Sie Ihre Angaben anhand Ihres Zählers oder Sicherungskastens.",
    },
    title: "Welche Hauptsicherung haben Sie?",
    subtitle:
      "Die Hauptsicherung dient zur Abschätzung, wie groß ein Wechselrichter normalerweise angeschlossen werden kann. Die tatsächlich zulässige Leistung bestimmt der Netzbetreiber.",
    ...
    noCountryOptions:
      "Für dieses Land haben wir noch keine verifizierten Anschlussoptionen. Geben Sie Ihre Hauptsicherung in Ampere ein und passen Sie die Netzeinstellungen unten bei Bedarf an.",
    unverifiedCountryNotice:
      "Wir haben den Netzstandard für dieses Land nicht verifiziert. Prüfen Sie Spannung, Phasen und Anschlussgröße auf Ihrer Stromrechnung oder beim Netzbetreiber und bestätigen Sie unten.",
  ...
  result: {
    ...
    estimatedConsumptionNote:
      "Der Monatsverbrauch wird aus Ihrem Jahreswert und dem gewählten Profil geschätzt.",
    ...
    coverageNote:
      "Diese Zahl vergleicht die gesamte Jahresproduktion mit dem gesamten Jahresverbrauch. Es handelt sich nicht um einen Autarkiegrad.",
    ...
    priceScenarioHint:
      "Eine Annahme über die jährliche Änderung, keine Prognose. Der Preis wird über den Berechnungszeitraum Jahr für Jahr angehoben.",
    ...
    standardValueHint:
      "Standardwerte für die Berechnung. Passen Sie sie an die Werte Ihres eigenen Stromvertrags an, um ein individuelleres Ergebnis zu erhalten.",
    exportValueInfo:
      "Geben Sie die Gesamtvergütung pro kWh für ins Netz eingespeisten Strom an, einschließlich etwaiger Netznutzung oder anderer einspeisebezogener Vergütungen.",
    editable: "Anpassbar",
    editableTooltip: "Annahme ändern",
    fuseLimit: "Theoretische Leistungsgrenze durch Hauptsicherung",
    fuseLimitInfo:
      "Berechnet aus Hauptsicherung und Netzspannung. Die tatsächlich zulässige Wechselrichter- oder Einspeiseleistung kann vom Netzbetreiber und lokalen Netzregeln begrenzt werden.",
    reason: {
      profileUnknown:
        "Die Dimensionierung ist auf Ihren Stromverbrauch und die geschätzte Solarstromproduktion abgestimmt.",
      profileNormal:
        "Die Dimensionierung ist auf Ihren Stromverbrauch und die geschätzte Solarstromproduktion abgestimmt.",
      profileLowSolarSeason:
        "Ein großer Teil Ihres Stromverbrauchs fällt an, wenn die Solarproduktion geringer ist. Daher wurde die Anlage nicht weiter überdimensioniert.",
      profileHighSolarSeason:
        "Sie verbrauchen in den sonnenreichen Monaten relativ viel Strom. Daher kann eine etwas höhere Modulleistung im Verhältnis zum Wechselrichter geeignet sein.",
      profileVeryHighSolarSeason:
        "Ihr Stromverbrauch konzentriert sich deutlich auf die sonnenreichen Monate. Daher wird eine höhere Modulleistung im Verhältnis zum Wechselrichter vorgeschlagen.",
      gridLimit:
        "Die Anlage wird durch Ihre Hauptsicherung begrenzt – eine größere Leistung lässt Ihr Netzanschluss nicht zu.",
      minimumSize:
        "Ihr Stromverbrauch ist gering, daher schlagen wir die kleinste sinnvolle Anlage vor.",
      maximumSize: "Der Vorschlag ist auf die größte Größe begrenzt, die die App dimensioniert.",
    },
    monthlyDataNote:
      "Monatswerte zeigen nicht, ob der Strom tagsüber oder nachts verbraucht wird. Sie dienen daher als Richtwert für die Dimensionierung, nicht als Beleg dafür, wie viel Solarstrom Sie selbst nutzen können.",
    ...
    rationale: {
      consumption:
        "Dimensioniert, um ungefähr so viel Strom zu produzieren, wie Sie jährlich verbrauchen.",
      gridLimit:
        "Die Anlage wird durch Ihre Hauptsicherung begrenzt – eine größere Leistung lässt Ihr Netzanschluss nicht zu.",
      inverterLimit:
        "Die Größe ist auf den größten geeigneten Wechselrichter für Ihren Anschluss abgestimmt.",
      minimumSize:
        "Ihr Stromverbrauch ist gering, daher schlagen wir die kleinste sinnvolle Anlage vor.",
      maximumSize: "Der Vorschlag ist auf die größte Größe begrenzt, die die App dimensioniert.",
    },
    ...
    selfConsumedValueHelp:
      "Eigenverbrauchte Solarenergie ersetzt Strom, den Sie sonst aus dem Netz hätten kaufen müssen.",
    ...
    economicsDisclaimer:
      "Diese Beträge sind Kalkulationsannahmen, keine garantierten zukünftigen Preise.",
    ...
    investmentLevelNote:
      "Mit den heutigen Kalkulationsannahmen entspricht eine Amortisationszeit von {{years}} Jahren einer Investition von etwa {{amount}}.",
    ...
    quoteNote:
      "Die Berechnung verwendet dieselbe Produktion, denselben Eigenverbrauch und dieselben Strompreise wie Ihre aktuelle Berechnung.",
    priceExplainer:
      "Eigenverbrauchte Solarenergie ersetzt Strom, der sonst aus dem Netz hätte gekauft werden müssen. Eingespeister Solarstrom bringt stattdessen eine Vergütung für den ins Netz eingespeisten Strom.",
    ...
    investmentLevelInfo:
      "Zeigt ungefähr, welche Investitionskosten der von Ihnen gewählten Amortisationszeit entsprechen. Es handelt sich nicht um eine Schätzung der tatsächlichen Installationskosten. Der tatsächliche Preis hängt unter anderem vom Dach, der Installation, den Komponenten und dem Anbieter ab.",
    systemSizeInfoLabel: "Weitere Informationen",
    systemSizeInfo:
      "Die Berechnung ist eine Schätzung und dient als Orientierung. Tatsächliche Produktion, Eigenverbrauch, Strompreis, Vergütung, Installationskosten und wirtschaftliches Ergebnis können abweichen. Das Ergebnis stellt kein Angebot und keine Garantie dar.",
    productionCostInfoLabel: "Weitere Informationen",
    productionCostInfo:
      "Die Zahl basiert auf der maximalen Investition, die zu Ihrer gewählten Amortisationszeit passt, verteilt auf den gesamten im Berechnungszeitraum erwarteten Stromertrag. Es ist kein Marktpreis für die Installation.",
    maxInvestmentExplainer:
      "Um eine Amortisationszeit von etwa {{years}} Jahren zu erreichen, sollten die Installationskosten höchstens etwa {{amount}} betragen.",
    maxInvestmentNote:
      "Der Betrag ist eine Berechnung basierend auf Ihren Eingaben und Kalkulationsannahmen – kein Angebot oder eine Schätzung des Marktpreises.",
    missingMarketValues:
      "Wir haben keinen verifizierten Standardwert für dieses Land. Bitte geben Sie die Werte unten selbst ein.",
    currency: "Währung",
    ...
    consumptionTooLowNote:
      "Der angegebene Stromverbrauch ist sehr niedrig, das Ergebnis ist daher nur als Richtwert zu verstehen.",
    ...
    limitedByFuse:
      "Die Anlage wird durch Ihre Hauptsicherung begrenzt, nicht durch Ihren Verbrauch.",
    ...
    productionCostExplainer:
      "Wir teilen die Kosten der Anlage durch die geschätzte Produktion über den gesamten Berechnungszeitraum.",
    productionCostLabel: "Darf kosten",
    productionCostValueLabel: "Wert für dich",
    productionCostDifference: "Differenz",
    productionCostBasis:
      "Basierend auf {{investment}} und {{production}} kWh über {{years}} Jahre.",
    productionCostHigherValue:
      "In dieser Berechnung ist jede kWh mehr wert, als sie zu erzeugen kostet.",
    ...
    gridTooSmallBody:
      "Ihr aktueller Anschluss ({{maxKw}} kW) ist zu klein für die kleinste unterstützte Anlagengröße ({{minKw}} kW Wechselrichter). Erhöhen Sie die Hauptsicherung oder die vereinbarte Leistung, um fortzufahren.",
    missingSelfConsumedValue:
      "Strompreis fehlt. Geben Sie an, was Sie pro kWh zahlen, um den Wert des selbst genutzten Solarstroms zu sehen.",
    missingExportValue:
      "Einspeisevergütung fehlt. Geben Sie an, was Sie pro eingespeister kWh erhalten, um die Einnahmen zu berechnen.",
    missingInstallationCost:
      "Installationskosten fehlen. Geben Sie Ihr Angebot oder die geschätzte Investition ein.",
    economicsIncomplete: "Unvollständige Grundlage",
    enterValues: "Werte eingeben",
    economicsRequiresPrice:
      "Die Wirtschaftlichkeitsberechnung erfordert einen Strompreis. Geben Sie Ihre Preise ein, um Einsparung, Amortisation und Stromgestehungskosten zu sehen.",
    economicsRequiresPriceShort: "Erfordert Strompreis",
    gridUnverifiedTitle: "Netzdaten nicht verifiziert",
    gridUnverifiedWarning:
      "Die Netzannahmen beruhen auf generischen Werten und müssen vor der Installation lokal überprüft werden.",
    ...
    calcErrorBody:
      "Mit einigen Eingaben kann nicht gerechnet werden. Gehen Sie zurück und prüfen Sie Verbrauch, Netzanschluss und Annahmen.",
  },
  units: {
    kwhPerYear: "kWh/Jahr",
    kwhPerKwp: "kWh/kWp",
  ...
  settings: {
    ...
    singleNote:
      "Der Einmalkauf erfolgt, wenn du eine neue Berechnung startest — nicht von hier aus.",
  ...
  meta: {
    home: {
      ...
      description:
        "Berechnen Sie die empfohlene Solarkapazität, den Wechselrichter und die jährliche Produktion basierend auf Ihrer Adresse, Ihrem Stromverbrauch und Ihrer Hauptsicherung.",
      ogDescription:
        "Schritt-für-Schritt-Berechnung mit Standortdaten von PVGIS: kWp, Wechselrichter, monatliche Produktion und Wirtschaftlichkeit.",
    },
    result: {
  ...
  report: {
    fields: {
      ...
      gridConnectionValue: "{{voltage}} V, {{phases}}-phasig",
      gridMethodNote:
        "Die theoretische AC-Leistung geht von 400 V Dreiphasenanschluss aus und wird als 1,73 × 400 V × Hauptsicherung berechnet. Die tatsächlich zulässige Anschluss- oder Einspeiseleistung kann vom Netzbetreiber oder der konkreten Installation begrenzt werden.",
      gridMethodNoteContracted:
        "Die tatsächlich zulässige Anschluss- oder Einspeiseleistung kann vom Netzbetreiber oder der konkreten Installation begrenzt werden.",
      savings30Short:
        "Berechnet mit {{degradation}} % jährlicher Produktionsminderung und unveränderten Stromwerten.",
      ...
      selfConsumptionRateNote:
        "Die Eigenverbrauchsquote zeigt, wie viel des erzeugten Solarstroms direkt in der Immobilie genutzt wird.",
      selfSufficiencyRateNote:
        "Der Autarkiegrad zeigt, wie viel des gesamten Stromverbrauchs der Immobilie direkt durch Solarstrom gedeckt wird.",
      ...
      priceMethodNote:
        "Die Stromwerte sind Kalkulationsannahmen. Der tatsächliche Wert von eigenverbrauchtem und eingespeistem Solarstrom hängt von Stromvertrag, Entgelten, Steuern, Regeln und Marktbedingungen ab.",
      ...
      priceChangeNote:
        "Eine Strompreisänderung von {{priceChange}} % pro Jahr bedeutet, dass die Kalkulation mit unveränderten Werten für selbst verbrauchten und eingespeisten Solarstrom über den gesamten Zeitraum rechnet. Es wird keine angenommene Preiserhöhung berücksichtigt, da zukünftige Strompreise nicht vorhersehbar sind. Höhere zukünftige Preise bedeuten einen höheren Wert als angezeigt, niedrigere Preise einen geringeren Wert.",
      calculationPeriodNote:
        "Der Berechnungszeitraum von {{years}} Jahren ist die abgedeckte Zeitspanne und entspricht einer normalen technischen Lebensdauer einer Solaranlage. Alle langfristigen Beträge im Bericht sind die Summe von Jahr 1 bis Jahr {{years}}, wobei die Produktion jährlich um {{degradation}} % sinkt.",
      ...
      lifetimeNote:
        "Die Berechnung zeigt die geschätzte Entwicklung über {{years}} Jahre auf Basis der berechneten Produktion, der angenommenen Degradation und der gewählten Strompreisentwicklung. Tatsächliches wirtschaftliches Ergebnis und Produktion können im Zeitverlauf abweichen.",
      yearShort: "Jahr",
      reportId: "Berichts-ID",
      uncertaintyTitle: "Was kann das Ergebnis beeinflussen?",
      uncertaintyText:
        "Die tatsächliche Solarstromproduktion und das wirtschaftliche Ergebnis können von der Berechnung abweichen. Das Ergebnis wird unter anderem durch Wettervariationen, Verschattung, Ausrichtung und Neigung der Module, den tatsächlichen Stromverbrauch und dessen Zeitpunkt, Strompreise, Einspeisevergütung und die Anlagenleistung über die Zeit beeinflusst.",
      panelPower: "Modulleistung",
      summaryMethodFlat:
        "Berechnet mit {{degradation}} % jährlicher Produktionsminderung und unveränderten Werten für selbst verbrauchten und eingespeisten Solarstrom.",
      summaryMethodTrend:
        "Berechnet mit {{degradation}} % jährlicher Produktionsminderung und einer angenommenen jährlichen Änderung des Solarstromwerts von {{priceChange}} %.",
      specificYieldNote:
        "Der spezifische Ertrag ist der berechnete Ertrag pro installiertem kWp an diesem Standort, basierend auf Ausrichtung und Neigung Ihres Dachs. Er ist nicht die Gesamtjahresproduktion der Anlage.",
      investmentNote:
        "Das Investitionsniveau zeigt ungefähr, welche Investition der gewählten Amortisationszeit entspricht, basierend auf dem kumulierten wirtschaftlichen Wert, den die Berechnung bis zu diesem Jahr prognostiziert. Es wird durch die angenommene Änderung des Stromwerts und die Produktionsminderung beeinflusst und ist kein geschätzter Marktpreis oder ein Angebot.",
      ...
      lifetimeInvestmentLink:
        "Der kumulierte wirtschaftliche Wert bis Jahr {{years}} ist die Grundlage für das Investitionsniveau von etwa {{amount}} - es handelt sich um dieselbe Berechnung, nur gerundet.",
      annualValue: "Wirtschaftlicher Wert, Jahr 1",
      savings30: "Kumulierter wirtschaftlicher Wert über {{years}} Jahre",
      savings30Method:
        "Berechnungszeitraum: {{years}} Jahre. Produktionsminderung: {{degradation}} %/Jahr. Strompreisänderung: {{priceChange}} %/Jahr.",
      savings30Note:
        "Der langfristige wirtschaftliche Wert wird Jahr für Jahr mit {{degradation}} % jährlicher Produktionsminderung berechnet. Die Kalkulation geht von unveränderten Werten für selbst verbrauchten und eingespeisten Solarstrom aus.",
      ...
      balanceNote:
        "Die Jahresproduktion entspricht etwa {{percent}} % Ihres Jahresstromverbrauchs. Das bedeutet nicht, dass der gesamte produzierte Strom direkt in der Immobilie genutzt werden kann, da Produktion und Verbrauch zu unterschiedlichen Zeiten erfolgen.",
      ...
      gridMethodNoteDynamic:
        "Die theoretische AC-Leistung basiert auf Ihrem gewählten Netzanschluss: {{phases}}-phasig, {{voltage}} V, berechnet als {{factor}} × {{voltage}} V × Hauptsicherung. Die tatsächlich zulässige Anschluss- oder Einspeiseleistung kann vom Netzbetreiber oder der konkreten Installation begrenzt werden.",
    },
    title: "Solarbericht",
  ...
  paywall: {
    ...
    retry:
      "Wir konnten den Kauf gerade nicht bestätigen. Es geht nichts verloren — er wird automatisch freigeschaltet, sobald die Verbindung wieder funktioniert.",
    appOnly:
