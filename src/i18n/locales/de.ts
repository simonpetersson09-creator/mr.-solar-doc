export const de = {
  ...
  consumption: {
    validation: {
      ...
      monthOutOfRange: "Ein Monat liegt deutlich höher als die anderen. Prüfe deine Monatswerte, bevor du fortfährst.",
      monthUneven: "Ein Monat weicht von den anderen ab. Überprüfe ihn, falls das nicht richtig ist.",
    },
    shape: {
  ...
  meta: {
    ...
    paywall: {
      title: "Schalte deine Berechnung frei - Mr. Solar Doc",
      description:
        "Schalte deine Solarberechnung mit einem einmaligen Kauf frei oder hol dir Premium für unbegrenzte Berechnungen.",
      ogDescription: "Schalte die vollständige Solarberechnung und den PDF-Bericht frei.",
    },
  },
  months: {
  ...
  report: {
    ...
    generated: "Erstellt",
    installerChecklistTitle: "Mit deinem Installateur zu besprechen",
    installerChecklistItems: [
      "Bestätige vor Ort die Ausrichtung, Neigung und mögliche Verschattung des Dachs.",
      "Beachte, dass die Anlagengröße je nach den tatsächlichen Gegebenheiten des Dachs, wie Schornsteinen, Lüftungsrohren oder begrenzter nutzbarer Fläche, angepasst werden muss.",
      "Prüfe die Hauptsicherung und die Anschlussbedingungen mit deinem Netzbetreiber.",
      "Bestätige, dass die Wechselrichterleistung von {{acPower}} zu deinem Stromanschluss passt.",
      "Vergleiche die vom Installateur geschätzte Jahresproduktion mit der {{production}} dieses Berichts. Schätzungen können je nach Bedingungen und Berechnungsmethode abweichen.",
      "Frage, ob der Wechselrichter für einen zukünftigen Batteriespeicher vorbereitet ist, falls das relevant werden könnte.",
      "Stelle sicher, dass der Sicherungskasten und die bestehende Elektroinstallation für die Anlage geeignet sind.",
      "Gehe durch, was im Angebot enthalten ist, zum Beispiel Verkabelung, Montage, Schutz und weiteres Installationsmaterial.",
      "Frage, wer bei eventuellen Schäden am Dach während der Installation haftet.",
      "Besprich Ertragsüberwachung, Garantien und Service.",
      "Fordere ein Angebot auf Basis der Auslegung dieses Berichts an: {{kwp}} · {{production}}.",
      "Vergleiche den Angebotspreis mit dem in diesem Bericht berechneten Wert von {{investment}}. Der Preis kann je nach Ausrüstung, Installationsbedingungen und Lieferumfang abweichen.",
    ],
